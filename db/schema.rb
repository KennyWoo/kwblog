...
ActiveRecord::Schema.define(version: 2019_07_05_084514) do
  ...
  create_table "tutorial_categories", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", limit: 64, null: false, comment: "名称"
    t.text "description", comment: "描述"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "tutorials", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "title", limit: 64, null: false, comment: "标题"
    t.text "content", comment: "内容"
    t.bigint "tutorial_category_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tutorial_category_id"], name: "index_tutorials_on_tutorial_category_id"
  end
